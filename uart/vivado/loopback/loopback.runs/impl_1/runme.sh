...
HD_PWD='Z:/home/thata/src/verilog_building_blocks/uart/vivado/loopback/loopback.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log loopback.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source loopback.tcl -notrace
